...
- Location: tests\chat.spec.js:196:3
...
Call log:
  - waiting for locator('.conversation-item[data-conv-id="conv-1"]') to be visible
    130 × locator resolved to hidden <li tabindex="0" role="button" data-conv-id="conv-1" class="conversation-item " aria-label="Conversa com Geral LUP">…</li>
